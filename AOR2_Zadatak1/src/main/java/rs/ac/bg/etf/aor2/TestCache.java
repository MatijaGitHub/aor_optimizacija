package main.java.rs.ac.bg.etf.aor2;

import main.java.rs.ac.bg.etf.aor2.loader.ITraceLoader;
import main.java.rs.ac.bg.etf.aor2.loader.NativeArrayTraceLoader;
import main.java.rs.ac.bg.etf.aor2.loader.NativeArrayTraceLoader.*;
import main.java.rs.ac.bg.etf.aor2.loader.ValgrindTraceLoader;
import main.java.rs.ac.bg.etf.aor2.memory.MemoryOperation;
import main.java.rs.ac.bg.etf.aor2.memory.PrimaryMemory;
import main.java.rs.ac.bg.etf.aor2.memory.cache.CacheMemoryWriteBackWriteAllocated;
...
import main.java.rs.ac.bg.etf.aor2.replacementpolicy.LRUReplacementPolicy;
import main.java.rs.ac.bg.etf.aor2.replacementpolicy.RandomPseudoLRUPolicy;
...
public class TestCache {
    ...
    private static void createCacheAndTest(int adrSize, int setAsoc, int blockNum, int blockSize, String fNameStatistic) {
        ...
        IReplacementPolicy policy = new RandomPseudoLRUPolicy();
        ...
        printStatisticsToFile(cacheL1D,fNameStatistic);
    ...
    private static void myValgrindTest(ICacheMemory cacheI,ICacheMemory cacheD) {
        ...
        try (ValgrindTraceLoader loader = new ValgrindTraceLoader("C:\\Users\\Matija Milosevic\\IdeaProjects\\AOR2_Zadatak1\\src\\matrix.txt")) {
